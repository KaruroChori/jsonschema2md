...
export async function main(args) {
  ...
  const { argv } = yargs(args)
    ...
    .alias('n', 'meta-index')
    .describe('n', 'add metadata elements to .md index files Eg -mi template=reference. Multiple values can be added by repeating the flag Eg: -mi template=reference -mi hide-nav=true')
    .coerce('n', (n) => n && pipe(
      // turn this into an object of key value pairs
      iter(n),
      map((i) => i.split('=')),
